...
using System.Linq;
using QwMicroKernel.Environment.CommandLineParser;

namespace QwMicroKernel.Environment
{
    /// <summary>
    ...
    public static class CommandLine
    {
        ...
        public static string GetUnparsedCommandLine()
        {
            ...
            string applicationPath = System.Environment.GetCommandLineArgs().First();

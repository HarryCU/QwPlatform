...
namespace QwMicroKernel.Environment.CommandLineParser
{
        ...
        ICommandLineElementParser<TResult>
    {
        ...
        public Parser<IEnumerable<ICommandLineElement>, ICommandLineElement> AnyElement
        {
            get
            {
                return input => input.Any() ? new Result<IEnumerable<ICommandLineElement>, ICommandLineElement>(input.First(), input.Skip(1)) : null;
            }
        }

...
namespace QwMicroKernel.Configuration
{
    /// <summary>
    ...
    public class PropertiesParser
    {
        ...
        {
            string val = _props[name] ?? defaultValue;
            if (val == null)
            {
                return defaultValue;
            }
        ...
        /// <param name="name">The name.</param>
        /// <returns></returns>
        public virtual IList<string> GetStringArray(string name)
        {
        ...
        /// <param name="defaultValue">The default value.</param>
        /// <returns></returns>
        public virtual IList<string> GetStringArray(string name, string[] defaultValue)
        {
        ...
        /// <param name="name">The name.</param>
        /// <returns></returns>
        public virtual IList<int> GetIntArray(string name)
        {
        ...
        /// <param name="defaultValue">The default value.</param>
        /// <returns></returns>
        public virtual IList<int> GetIntArray(string name, IList<int> defaultValue)
        {
            string vals = GetString(name);
            if (vals == null)
            {
        ...
        /// <returns></returns>
        public virtual long GetLong(string name, long def)
        {
            string val = GetString(name);
            if (val == null)
            {
        ...
        /// <param name="def">The def.</param>
        /// <returns></returns>
        public virtual TimeSpan GetTimeSpan(string name, TimeSpan def)
        {
            string val = GetString(name);
            if (val == null)
            {
        ...
        /// <param name="prefix">The prefix.</param>
        /// <returns></returns>
        public virtual NameValueCollection GetGroup(string prefix)
        {
            return GetGroup(prefix, false);
        }
        ...
        /// <returns></returns>
        public virtual NameValueCollection GetGroup(string prefix, bool stripPrefix)
        {
            return GetGroup(prefix, stripPrefix, null);
        }
        ...
        public virtual NameValueCollection GetGroup(string prefix, bool stripPrefix, string[] excludedPrefixes)
        {
        ...
        /// <returns></returns>
        public static PropertiesParser LoadFromEmbeddedAssemblyResource(string resourceName)
        {
            return LoadFromStream(typeof(PropertiesParser).Assembly.GetManifestResourceStream(resourceName));
        }
        ...
        /// <returns></returns>
        public static PropertiesParser LoadFromFileResource(string fileName)
        {
            return LoadFromStream(File.OpenRead(fileName));
        }

        private static PropertiesParser LoadFromStream(Stream stream)
        {

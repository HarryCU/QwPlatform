...
namespace QwMicroKernel.Threading
{
    ...
    /// </code>
    /// </summary>
    public delegate void SafeThreadStart();
    ...
    public partial class SafeThread : MarshalByRefObject
    {
        ...
        /// </summary>
        protected ParameterizedThreadStart ParamterizedStart;
        /// <summary>
        /// the SimpleDelegate target, if any
        /// </summary>
        protected SafeThreadStart safeStart;
        ...
        /// </summary>
        /// <param name="sd"></param>
        public SafeThread(SafeThreadStart sd)
            : this()
        {
            safeStart = sd;
            ParamterizedStart = new ParameterizedThreadStart(this.CallDelegate);
            _thread = new Thread(ParamterizedStart);
        }

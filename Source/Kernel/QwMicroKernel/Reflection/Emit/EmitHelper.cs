...
namespace QwMicroKernel.Reflection.Emit
{
    ...
    public class EmitHelper
    {
        ...
        public EmitHelper ldarg(ParameterInfo parameterInfo)
        {
            ...
            bool isStatic =
                Method is MethodBuilder && ((MethodBuilder)Method).Builder.IsStatic;
        ...
        public EmitHelper Init(ParameterInfo parameterInfo, int index)
        {
            ...
            Type type = TypeExtensions.GetUnderlyingType(parameterInfo.ParameterType);
        ...
        public EmitHelper CastIfNecessary(Type expectedType, Type actualType)
        {
            ...
            return
                TypeExtensions.IsSameOrParent(expectedType, actualType) ? this :
        ...
        {
            return new InvalidOperationException(string.Format("在{0}类型中未发现{1}方法!", type.FullName, methodName));
        }

        private static Exception CreateNotExpectedTypeException(Type type)
        {
            return new ArgumentException(string.Format("未能发现{0}类型!", type.FullName));
        }
    }
}

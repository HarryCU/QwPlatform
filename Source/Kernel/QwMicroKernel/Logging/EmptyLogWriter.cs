...
{
    public abstract class EmptyLogWriter : ILogWriter
    {
        private readonly LoggingLevel _level;

        protected EmptyLogWriter(LoggingLevel level)
        {
            _level = level;
        }
        ...
        protected abstract void LogInternal(LoggingLevel level, object obj, Exception exception);
    }
}

...
namespace QwMicroKernel.Reflection.Emit
{
    ...
    using RefFieldBuilder = FieldBuilder;
    using RefCustomAttributeBuilder = CustomAttributeBuilder;
    using RefTypeBuilder = System.Reflection.Emit.TypeBuilder;
    ...
    {
        private readonly MemoryAssemblyBuilder _assembly;
        private readonly RefTypeBuilder _typeBuilder;
        private ConstructorBuilder _typeInitializer;
        private ConstructorBuilder _defaultConstructor;
        private IDictionary<MethodInfo, MethodBuilder> _overriddenMethods;

        /// <summary>
        /// Initializes a new instance of the <see cref="TypeBuilder"/> class
        /// with the specified parameters.
        /// </summary>
        /// <param name="assemblyBuilder">Associated <see cref="AssemblyBuilder"/>.</param>
        /// <param name="typeBuilder">A <see cref="TypeBuilder"/></param>
        public TypeBuilder(MemoryAssemblyBuilder assemblyBuilder, RefTypeBuilder typeBuilder)
        {
        ...
        /// <summary>
        /// Gets associated <see cref="AssemblyBuilder"/>.
        /// </summary>
        public MemoryAssemblyBuilder Assembly
        {
        ...
        /// </summary>
        public IDictionary<MethodInfo, MethodBuilder> OverriddenMethods
        {
            get { return _overriddenMethods ?? (_overriddenMethods = new Dictionary<MethodInfo, MethodBuilder>()); }
        }

        /// <summary>
        /// Converts the supplied <see cref="TypeBuilder"/> to a <see cref="TypeBuilder"/>.
        /// </summary>
        /// <param name="typeBuilder">The <see cref="TypeBuilder"/>.</param>
        /// <returns>A <see cref="TypeBuilder"/>.</returns>
        public static implicit operator RefTypeBuilder(TypeBuilder typeBuilder)
        {
            if (typeBuilder == null) throw new ArgumentNullException("typeBuilder");
        ...
        {
            return new MethodBuilder(this, _typeBuilder.DefineMethod(name, attributes, returnType, parameterTypes));
        }
        ...
        public MethodBuilder DefineMethod(
            ...
            Type[] parameterTypes)
        {
            return new MethodBuilder(this, _typeBuilder.DefineMethod(
        ...
        public MethodBuilder DefineGenericMethod(
            string name,
            MethodAttributes attributes,
            CallingConventions callingConvention,
        ...
        /// <param name="methodInfoDeclaration">The method whose declaration is to be used.</param>
        /// <returns>The defined method.</returns>
        public MethodBuilder DefineMethod(string name, MethodInfo methodInfoDeclaration)
        {
        ...
        /// <param name="methodInfoDeclaration">The method whose declaration is to be used.</param>
        /// <returns>The defined method.</returns>
        public MethodBuilder DefineMethod(MethodInfo methodInfoDeclaration)
        {
            if (methodInfoDeclaration == null) throw new ArgumentNullException("methodInfoDeclaration");
        ...
        /// </summary>
        public ConstructorBuilder TypeInitializer
        {
            get
            {
                if (_typeInitializer == null)
                    _typeInitializer = new ConstructorBuilder(this, _typeBuilder.DefineTypeInitializer());
        ...
        public ConstructorBuilder DefaultConstructor
        {
            get
            {
                ...
                {
                    RefConstructorBuilder builder = _typeBuilder.DefineConstructor(
                        MethodAttributes.Public,
                        CallingConventions.Standard,
                        Type.EmptyTypes);

                    _defaultConstructor = new ConstructorBuilder(this, builder);
                }
        ...
        public RefFieldBuilder DefineField(string fieldName, Type type, FieldAttributes attributes)
        {
        ...
        public ConstructorBuilder DefinePublicConstructor(params Type[] parameterTypes)
        {
        ...
        {
            return new TypeBuilder(_assembly, _typeBuilder.DefineNestedType(name));
        }
        ...
        /// TypeBuilder.DefineNestedType Method</seealso>
        public TypeBuilder DefineNestedType(string name, Type parent)
        {
